...
<body>
  <div class='w3-container'>
    ...
    <section class="w3-padding" id='dashboard'>
      ...
      <h2 class='w3-text-red'>Create a type</h2>
      ...
      <form action="/console/types/create" method="POST" class='w3-margin-bottom' novalidate>
        <?= csrf_field() ?>
        <label for="title">Title</label>
        <input type="text" name="title" id="title" class='w3-input w3-border w3-margin-bottom' value="<?= old('title') ?>" />
